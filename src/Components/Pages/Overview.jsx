  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        ...
        <button className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition-colors text-sm md:text-base">
          <FiRefreshCw /> Refresh
        </button>
      </div>
        ...
        {stats.map((stat, index) => (
          <div key={index} className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex justify-between">
              ...
              <div className="p-2 md:p-3 rounded-full bg-opacity-20 bg-indigo-100">
                {stat.icon}
              </div>
            </div>
      ...
      {/* Quick Actions */}
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        <h3 className="font-medium text-gray-800 mb-3 md:mb-4">Quick Actions</h3>
        <div className="flex flex-wrap gap-2 md:gap-3">
          <button className="px-3 py-1.5 md:px-4 md:py-2 bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 transition-colors text-sm md:text-base">
            Reboot All
          </button>
          <button className="px-3 py-1.5 md:px-4 md:py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors text-sm md:text-base">
            Backup Config
          </button>
          <button className="px-3 py-1.5 md:px-4 md:py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors text-sm md:text-base">
            Generate Report
          </button>
        </div>
      </div>
